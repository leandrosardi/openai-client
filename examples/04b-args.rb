...
# Explicitly invoke the `count_tags` function:
puts '---'
puts $ai.ask(
  "Please tell me how many tags I have.",
  function_to_call: "count_tags"
)
=end
# Explicitly invoke the `list_tags` function with pagination arguments:
puts '---'
tags = $ai.ask(
